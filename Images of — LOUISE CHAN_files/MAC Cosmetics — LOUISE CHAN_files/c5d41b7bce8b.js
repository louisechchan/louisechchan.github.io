...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    (e.strs = [
      ...
      "Language",
      "Note: after you connect, your device may automatically save this network and connect to it in the future. You can delete the network in your Wi-Fi settings anytime.",
      "am",
      "Open Media Gallery",
      ...
      "This video is sharing ad earnings because it may contain content owned by {reference owner name}",
      "Don't allow optional cookies",
      ...
      "AR commerce virtual try-on experience",
      ...
      "Your phone number",
      "Phone Number",
      "Why {group_username} was reported",
      ...
      "Ethereum provider does not exist.",
      "{weeks} weeks ago",
      "Firefox",
      ...
      "To block {Username of current profile}, you'll need to remove them from supervision.",
      ...
      "No recent searches.",
      "Resend Code.",
      "You can also {= report content you believe is unlawful} under the Network Enforcement Act (NetzDG) without logging in.",
      ...
      "Checkmark icon",
      "Apps and Websites",
      "Business accounts are best for retailers, local businesses, brands, organizations and service providers. You can switch back to a creator account anytime.",
      ...
      "Close",
      "Video upload failed.",
      "To block {Username of current profile}, you'll need to remove them from supervision using the Instagram app.",
      ...
      "You're now private. Update more privacy settings?",
      "Directories",
      "Ads you've interacted with",
      "{Submit a dispute text bolded} if you have permission to use all the content in your video. By submitting a dispute, you give {owner name}, who has issued this claim, permission to review your video. They can also review the entire post, if you've shared it publicly. They will have 7 days to respond.",
      "Animated checkmark",
      "Back to Log In",
      "Locations",
      "Get Started",
      ...
      "This link will only work for 14 days after we send it. Because it may contain personal information, be sure to keep the link private and only download the file to your own computer.",
      ...
      "monetization policy",
      "Scan the QR code below to continue shopping on the app.",
      "Close icon",
      "Private account",
      "I don't like this comment",
      "People can scan this QR code with their smartphone's camera to see this location.",
      "Back",
      "Our cookies on other apps and websites",
      "{filename} could not be uploaded.",
      "Would you like to log into {=appDisplayName} using your Instagram account?",
      "{count} more",
      "Expand to add Alt Text",
      "Use Security Code",
      "This is an unlock image.",
      "Verified",
      "Add phone number",
      "Learn More",
      "Original",
      ...
      "People can scan this QR code with their smartphone's camera to see this guide.",
      ...
      'These are apps and websites that are no longer connected to your Instagram account. They can\'t access your non-public information anymore, but may still have the information you shared while they were active. "Non-public" means information that an app can only access if you choose to share it when you log in with your Instagram account (like your email address). You can ask an app to delete your information. To do it, review their Privacy Policy for details and contact information. If you contact an app, they may need your User ID.',
      ...
      "Enter 3-digit code",
      "Call",
      "{hour_amount} and {minute_amount}",
      "I don't like this message",
      "You can't access certain features right now",
      "People",
      "Confirm",
      "Thanks! You've resubscribed to Instagram's emails.",
      ...
      "This link will only work for 7 days after we send it. Because it may contain personal information, be sure to keep the link private and only download the file to your own computer.",
      "Watch Story",
      "Ineligible Video",
      "Driver's license",
      "Unlike",
      ...
      "Log In",
      "One or more videos were too long to be uploaded.",
      "Continue",
      ...
      "In most cases, you'll be able to change your username back to {trustedUsername} for another {trustedDays} days.",
      "Report",
      "Personal Information",
      ...
      "full list of streaming software partners.",
      ...
      "We removed this {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because we want to encourage safety and compliance with local legal restrictions that may apply.",
      "Call",
      "Dismiss",
      "Two-factor authentication through an authentication app can only be turned on using the Instagram app.",
      "Buy on Instagram",
      ...
      "Only you can see the total number of views and likes on your posts.",
      ...
      "Payment Method",
      "Audience",
      "If you continue, this live video won't be saved unless you've previously chosen to archive all your live videos for 30 days.",
      "Subscribe to:",
      "Facebook Pay",
      ...
      "Embed Code Copied!",
      "After that, the app will be locked until {end time of schedule break}.",
      "Most recent",
      ...
      "Your activity off Meta technologies is still turned off for other apps and websites. You can turn on all activity in order to be able to connect apps and websites to your Instagram without individually reconnecting them.",
      "Continue as {username}",
      "Remove",
      "See More",
      ...
      "{decisionMakerString} this {contentTypeText} goes against our {communityGuidelinesLink}. Even if you didn't mean to offend, our guidelines encourage people to express themselves in a way that's respectful to everyone.",
      "Login",
      "Accessibility",
      ...
      "Spam or Scam",
      "Chime in and join the conversation.",
      "Full Name",
      "Use Less Data",
      "Can't load stickers",
      "Continue",
      "A link in your profile goes against our {Community Guidelines}. This link is stopping you from accessing certain features on Instagram, like posting, tagging, and commenting.",
      "If you allow, {=business name} will be able to see your public information.",
      ...
      "Don't miss a post from {username}",
      ...
      "Username",
      "We're asking because you've purchased ads. Use your own personal birthday, even if this account is for something like a business or pet.",
      "{decisionMakerString} your {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because violence can make some people feel unsafe on Instagram.",
      "Try It",
      "City/town (optional)",
      "Authorize",
      "Block",
      ...
      "{decisionMakerString} your {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. If you post something that goes against our guidelines again, your account may be deleted, including your posts, archive, messages and followers.",
      ...
      "By submitting a dispute, you give the rights holder, {reference owner name} permission to review your photo and basic public information about your account. They will have 7 days to respond.",
      "User not found.",
      "Thank you for reviewing our updated Privacy Policy and agreeing to our new Terms.",
      "Learn More",
      ...
      "Prefer Not To Say",
      "Anyone will be able to see your photos and videos on Instagram. This won't change who can message, tag, or @mention you.",
      ...
      "{decisionMakerString} your {contentTypeText} goes against our {communityGuidelinesLink}. If you learn and follow our guidelines, you can prevent your account from being deleted.",
      "Create username",
      "Learn More",
      ...
      "Ad settings",
      "Clicking this button will remove the link and you will now have access to all features.",
      ...
      "{decisionMakerString} this {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. Our guidelines are based on our global community, and some audiences may be sensitive to different things.",
      "Down Chevron Icon",
      "What was removed",
      "Add to Home screen",
      "Use the app",
      ...
      "Switch Back",
      "Your public posts or profile can be shown outside of Instagram, including articles and blogs.",
      "{firstUsername} and {secondUsername}",
      "If you're concerned about the recent update to our Terms and Privacy Policy, you can {press center post}",
      "Load more comments",
      ...
      "News/media",
      "Report Under NetzDG",
      "This Story In {group_profile_username} Goes Against Our Community Guidelines",
      "Messages",
      ...
      "We removed this {contentTypeText} because it goes against our {communityGuidelinesLink}. If you learn and follow our guidelines, you can prevent this group profile from being deleted.",
      ...
      "Leave",
      "Unable to block user - you are being supervised by the user you are trying to block.",
      "Interest Topics",
      ...
      "Discard post?",
      "Email Removed",
      "These cookies are required to use Facebook Products. They’re necessary for these sites to work as intended.",
      "Ads",
      ...
      "Next",
      "{decisionMakerString} this {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. Following our guidelines is the only way to prevent this group profile from being deleted, including the posts and members.",
      "City/Town",
      ...
      "We removed this content because a third party reported that it infringes their intellectual property rights.",
      "They can't see when you're online or when you've read their messages. You can unrestrict them from their profile.",
      "Intellectual property violation",
      "Contact buttons are only visible on your profile in the Instagram mobile app.",
      ...
      "Seen today",
      "1 year old",
      "Use the app to finish liking {username}'s post.",
      ...
      "Discover more photos and videos from this account.",
      ...
      "After that, the app will be locked until tomorrow.",
      ...
      "Verified",
      "Easily go back to your favorite posts and share them with friends.",
      "No",
      ...
      "Report",
      "{count} others",
      "We removed this {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because we want our community to feel respected and safe.",
      "Terms of Use",
      "Add Manually",
      ...
      "Log into {username} to continue. You'll be logged out of {source_account_username}.",
      ...
      "No Posts Yet",
      "Your request to change an author interest has failed. Please reload the page and try again.",
      ...
      "Submit Dispute",
      "Ad icon on Accounts Center Interstitial",
      "File is Too Large",
      "Saved",
      "Photo",
      "Filtering Comments",
      ...
      "We're asking because we need your own personal birthday, even if this account is for a business, a pet or something else.",
      ...
      "Account Data is going away in April. You can still access your account information in Data Download.",
      "More options",
      "You may want to revisit your other privacy settings to make sure that you can interact with the people you want.",
      ...
      "Unrestrict",
      "App Store",
      "This is because a link in your profile goes against our Terms of Service or Community Guidelines.",
      ...
      "Clear the City/Town search box.",
      "Update App",
      "Account Data",
      ...
      "Continue as @{username}",
      "Message {actionType}",
      "We're recommending your account to people who are interested in the selected topics. You can choose which topics to associate with your account by turning them on or off.",
      "phone number",
      "{follower count} Followers",
      "Also known as (Optional)",
      "Controlling Cookies With Browser Settings",
      "Get {page_name}'s Wi‑Fi password.",
      ...
      "",
      "You're now public. Update more privacy settings?",
      "Tap to play",
      ...
      "The link we sent to {email address} only works for fourteen days. You can request another copy of your data.",
      "Confirm PIN",
      ...
      "Profile saved!",
      "This will remove the video from your post.",
      "PINNED",
      ...
      "Select Embed Code",
      "Get Now",
      "Your activity off Meta technologies is currently turned off for {=application name}. By continuing, you will:",
      "Password changed.",
      "No results found.",
      "th",
      "Continue as {username}",
      ...
      "Dismiss",
      "Geoblocked content",
      "Thank you for reviewing our updated {privacy_policy} and agreeing to our new {terms_of_service} .",
      ...
      "We use tools from other companies for advertising and measurement services off of Facebook Products, analytics, and to provide certain features and improve our services for you. These companies also use cookies.",
      ...
      "Your activity off Meta technologies is currently turned off. By continuing, you will:",
      "Choose File",
      ...
      "See More",
      "Confirm Log In?",
      "We removed this {contentTypeText} because it goes against our {communityGuidelinesLink}. Even if the author didn't mean to offend, our guidelines encourage people to express themselves in a way that's respectful to everyone.",
      ...
      "{decisionMakerString} this {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because we want our community to feel respected and safe.",
      "We'll ask for a security code when we need to confirm that it's you logging in.",
      "Our review team works in many languages to make sure our guidelines are applied consistently.",
      "View More",
      "Other",
      ...
      "May",
      "Select Go live once your streaming software connects and displays as a preview.",
      "Ok",
      "Saved Collection",
      "Select Crop",
      "Change",
      "GIF",
      "We remove links with:",
      "Allow Ads",
      "Logging Out",
      ...
      "Reels",
      "Your account or group profile may be deleted",
      ...
      "Push Notifications",
      "This monetization tool is no longer available",
      ...
      "photos",
      "{num_hours} hours",
      "Licensing icon on Accounts Center Interstitial",
      ...
      "Email Sent",
      "February",
      "Auto-generated captions added to your video help people with hearing impairments. They are only displayed on the iOS and Android apps and may take a few minutes to appear.",
      "Change Your Password to Secure Your Account",
      "Privacy and Security Help",
      "Continue shopping and browse more products on the app.",
      ...
      "This may take more than 48 hours due to the high number of requests we’re receiving.",
      ...
      "Profile Update",
      "Family Center features like supervision are available on iOS and Android devices. {Learn more}",
      "20+ Requests",
      "Digital collectible",
      "Add a title...",
      ...
      "Share Post",
      "Spam",
      "Navigate back to chat from thread details",
      ...
      "GIF",
      "Feed",
      "Don't have the Instagram app? Get it now.",
      "",
      "Consent Page",
      "Continue on the Instagram app",
      "Make Admin",
      "This link doesn't work anymore because your account has been deleted. To keep using Instagram, create a new account.",
      "Password",
      'Showing 20 out of over 50,000 results for "{query}"',
      "Story Video Overlay",
      ...
      "Privacy concerns",
      "Get New Codes",
      "By turning on all activity, we'll show you more relevant ads and introduce you to products, services and events you might be interested in. Your activity that other apps and websites share with us will be stored with your account in Accounts Center. You're able to view or disconnect this activity at any time.",
      "Apps and Websites",
      "Live {actionType}",
      "Proceed to Checkout",
      "No comments yet.",
      ...
      "These are apps and websites you've connected to your Instagram account that you may not have used in the last 90 days. They're no longer able to access your non-public information, but may still have the information you shared while they were active. \"Non-public\" means information that an app can only access if you choose to share it when you log in with your Instagram account (like your email address).",
      ...
      "Icon to represent Live Video broadcasts on Instgram",
      ...
      "Unable to block user - you are the guardian of the user you are trying to block.",
      ...
      "Close",
      "Recent",
      "We use either technology or a review team to remove anything that doesn't follow our guidelines as quickly as possible.",
      "Business Address",
      "Edit options",
      "We created our {communityGuidelinesLink} to support and protect our community, and we removed this post because we’re concerned it may encourage self-harm or suicidal behavior. We understand this may not be the author's intention. We care about your safety, and if you’re going through something difficult, we’d like to help. We encourage you to get support through our resources.",
      "{decisionMakerString} your {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because we want our community to feel respected and safe.",
      "Suggestions For You",
      ...
      "You need to remove supervision first",
      ...
      "Got it. You've unsubscribed from Instagram's emails.",
      ...
      "Suspicious login has been confirmed",
      "Too many ads",
      ...
      "Failed to Load.",
      "{country} state-controlled media",
      ...
      "To continue, {appname} needs to access your Instagram account.",
      ...
      "Use the app to finish liking {username}'s highlight.",
      "Try it Out",
      ...
      "Follow {page_name} to get the password and see their latest posts. Or you can follow the business later.",
      ...
      "Move to Primary",
      "Cookies From Other Companies",
      "Once you start to preview the broadcast you have up to 5 hours to go live.",
      "Video call started",
      ...
      "Comments",
      "People can scan this QR code with their smartphone's camera to see this hashtag page.",
      ...
      "You have the right to challenge our decision in France's courts. In France, there are laws about what you can do online. If you break these laws, you could face criminal or civil legal action.",
      ...
      "This Post In {group_profile_username} Goes Against Our Community Guidelines",
      "Desktop icon",
      "Account Privacy",
      "Post",
      "Send",
      ...
      "View All",
      "Comment icon",
      "You can ask us to review our decision in your Support Requests. You have the right to complain to the Irish Data Protection Commission or any other supervisory authority. You also have the right to seek a judicial remedy before a competent court.",
      ...
      "Verified",
      "Turn This On?",
      "To continue shopping, scan the QR code below or send a notification to your app.",
      "Privacy",
      ...
      "{num_hours} hour",
      "Active today",
      "See more stories and posts from this location and places around the world.",
      "Log Out",
      "Post has been saved",
      "Dialog header image",
      "Delete photo?",
      ...
      "Messenger",
      "See a {Streaming partner list link}",
      ...
      "Now you can connect by opening your Wi-Fi settings and using this password for {ssid}.",
      "Search",
      "Ads",
      ...
      "Write alt text…",
      "Checkout in App",
      "{Submit a dispute text bolded} if you have permission to use all the content in your photo. By submitting a dispute, you give {owner name}, who has issued this claim, permission to review your photo. They can also review the entire post, if you've shared it publicly. They will have 7 days to respond.",
      "People can scan this QR code with their smartphone's camera to see this profile.",
      "SMS was resent.",
      ...
      "Comment Filtering",
      "Profile Update",
      "Two factor authentication lock icon",
      "Username",
      "Home",
      ...
      "Circle Check",
      "Terms",
      "We removed this {contentTypeText} because it goes against our {communityGuidelinesLink}. Following our guidelines is the only way to prevent this group profile from being deleted, including the posts and members.",
      ...
      "People can scan your QR code with their smartphone's camera to follow you.",
      ...
      "Dismiss",
      "Privacy",
      "{appname} needs to access info from your Instagram account.",
      "Made to save space and data. Download for free on Google Play.",
      "Your Instagram Business Account is Ready",
      "OK",
      "Members",
      "See more photos and videos from {name}, and connect with them in new ways.",
      "Log in to load more comments",
      "· You aren't receiving a benefit from this donation",
      "Location icon.",
      "Contact",
      "See this Instagram highlight by @{username}",
      ...
      "People can scan this QR code with their smartphone's camera to see this effect.",
      "Leave",
      "Display on profile",
      "Post Options",
      "You're about to temporarily deactivate your account. Go ahead?",
      "We'll send a code to the number you choose.",
      ...
      "Open the report numbers below to learn more about why this content was reported and what content was removed.",
      ...
      "Accept",
      "Text",
      "We removed this {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. Our guidelines are based on our global community, and some audiences may be sensitive to different things.",
      "Details",
      "There was a problem opening the camera. Try again.",
      "Problem Creating Your Account",
      "Terms",
      "Adding your number here lets Instagram use it to help you log in, protect our community, and assist you in accessing Instagram, but not for purposes such as suggesting friends or providing ads. Only you will see this number on your profile. If the number added here is provided elsewhere across Facebook Company Products, it may be used for other purposes including suggesting friends or providing ads.",
      "Support or praise of terrorism, organized crime, or hate groups",
      "Followed by {username}",
      "March",
      "You can start using the latest version of Instagram instead.",
      "Log in to comment",
      "Suspicious login has not been confirmed",
      ...
      "About us",
      "Email",
      "You can deactivate your account instead of deleting it. This means your account will be hidden until you reactivate it by logging back in.",
      "Next",
      "months",
      "Security Code",
      "Mobile Number",
      ...
      "Other",
      "{decisionMakerString} this {contentTypeText} goes against our {brandedContentPoliciesLink}. Certain goods, services, or brands cannot be promoted with branded content, including tobacco products, weapons, ammunition or explosives. In addition, some categories, including social issues, elections, or politics, are only allowed in branded content posts if the paying partner has been authorized to run related ads.",
      ...
      "Poll",
      "People can scan this QR code with their smartphone's camera to see this reel.",
      "Brightness",
      "Cancel",
      "Videos",
      "Learn More.",
      ...
      "Currently boosted",
      "Reason for dispute",
      "People who use our service may have uploaded your contact information to Instagram. {Contact uploading for non-users privacy policy}",
      ...
      "Error",
      "You can allow the use of all cookies, just essential cookies or you can choose more options below. We’ll remember your cookie choices and apply them anywhere you’re logged into Instagram, and where you use your accounts to log into other Facebook Products. You can review or change your choices at any time in your cookie settings.",
      "Switch Accounts",
      "Accounts Center",
      "Harassment or bullying",
      ...
      "Your Message Goes Against Our Community Guidelines",
      ...
      "We'll fetch your NFTs so you can share them as collectibles on Instagram. This can take up to 10 minutes.",
      ...
      "{applicationName} will share products with your Instagram account {username}. Insights on products’ performance will be shared with {applicationName}.",
      "Enter PIN",
      "Fade",
      "Your Files Have Expired",
      "th",
      "We can send a notification to {Username of guardian}. We’ll let them know that a report was made, but won’t share the details about who or what was involved.",
      "10 more minutes until your scheduled break",
      "{seconds} seconds ago",
      ...
      "{decisionMakerString} your {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. Following our guidelines is the only way to prevent your account from being deleted, including your posts, archive, messages and followers.",
      "Next",
      "Discover",
      "Block this user?",
      "Now you can reach people by posting directly from the Instagram website.",
      "You followed a link that requires you to be logged into {username}. You will be logged out of your current account.",
      "More highlights from the accounts you care about.",
      ...
      "Digital Collectible being edited",
      ...
      "You can choose to display or hide your contact info in your profile settings anytime. Contact buttons are only visible on your profile in the Instagram mobile app.",
      "Other Ways You Can Control Your Information",
      "Text (SMS) Messages",
      ...
      "This video file could not be read by your browser",
      "{decisionMakerString} your {contentTypeText} goes against our {communityGuidelinesLink}. Even if you didn't mean to offend, our guidelines encourage people to express themselves in a way that's respectful to everyone.",
      "Profile information",
      "Login Activity",
      "Hashtag",
      "Spinner placeholder",
      ...
      "New posts from your favorites will appear higher in feed.",
      "Ok",
      ...
      "The PIN entered is incorrect. Please try again.",
      "others",
      "You can choose what information is displayed on your profile. You can change this at any time.",
      "Not Now",
      "Restrict",
      "Copy Link",
      ...
      "This won't be part of your public profile, and will be saved to your personal information settings.",
      ...
      "Upload failed.",
      "Turn On",
      "You can use Instagram again after {end time of schedule break}.",
      "Log in as {username}",
      ...
      "Moved to General",
      "Send photos, videos, selfie stickers, and other messaging effects.",
      "Play Count Icon",
      "New Video Post",
      ...
      "Email Address",
      "{decisionMakerString} this {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. Even if the author didn't mean to offend, our guidelines encourage people to express themselves in a way that's respectful to everyone.",
      ...
      "Ad Report",
      "And {number of other followers account owner has}",
      ...
      "10 more minutes on Instagram today",
      "Followers",
      ...
      "Use the Instagram app to continue",
      "Authorization Request",
      "Two-Factor Authentication",
      "Community guideline",
      ...
      "Before you temporarily deactivate your account, you might want to take a look at these articles in our Help Center.",
      "Continue in browser",
      ...
      "Only your followers will be able to see your photos and videos on Instagram. This won't change who can message, tag, or @mention you.",
      "Countries",
      "Discard",
      "Live video",
      ...
      "Connect using the Coinbase extension.",
      "Profiles",
      ...
      "Month:",
      "In-stream video ads are no longer available",
      "Vignette",
      "You can only disable your account once a week.",
      "Manage Facebook Pay",
      "Locations",
      "Message removed for child nudity and sexual exploitation",
      "You've successfully updated your profile!",
      "Facebook Pay branding logo",
      "Use Instagram Lite",
      "Add Photo ID Icon",
      "How You Get Authentication Codes",
      "The link we sent to {email address} only works for seven days. You can request another copy of your data.",
      ...
      "Explore more places that inspire you and find new experiences to try.",
      "Post did not upload.",
      "Message Unavailable",
      "Something went wrong. Please try again.",
      ...
      "{decisionMakerString} this {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because we want to encourage safety and compliance with local legal restrictions that may apply.",
      "Learn more",
      "Public Business Information",
      ...
      "Only accounts you approve can see your photos and videos.",
      "Learn More",
      ...
      "Deleted",
      "Explore",
      "You can allow the use of all cookies, just essential cookies or you can choose more options below. You can learn more about cookies and how we use them, and review or change your choice at any time in our {Cookie Policy}.",
      "{count} likes",
      "Sun",
      "th",
      ...
      "Liked",
      "Discard live video?",
      "Direct messaging - {notificationCount} new notifications link",
      "Underage child",
      ...
      "ZIP Code",
      "Thanks!",
      "Choose who can see what you share. You can change this anytime in Settings.",
      "New Photo Post",
      "Change your name",
      "Update Your App",
      "Done",
      ...
      "We can send a notification to your guardian. We’ll let them know that a report was made, but won’t share the details about who or what was involved.",
      "This is a lock icon.",
      "Profile",
      "Instagram Lite",
      "Oct",
      ...
      "{decisionMakerString} this {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. If a member posts something that goes against our guidelines again, the group profile account may be deleted, including the posts and members.",
      ...
      "Comments",
      "Learn more",
      "We removed this {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. If a member posts something that goes against our guidelines again, the group profile may be deleted, including the posts and members.",
      "Watch Now",
      ...
      "Allow people to embed your posts or profile on other websites",
      ...
      "{decisionMakerString} your {contentTypeText} goes against our {communityGuidelinesLink}. Following our guidelines is the only way to prevent your account from being deleted, including your posts, archive, messages and followers.",
      "Active {hours}h ago",
      ...
      "Only {story owner username}'s subscribers can see this story.",
      "Suggested",
      "Previous",
      "{decisionMakerString} your {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because we want to encourage safety and compliance with local legal restrictions that may apply.",
      "Log in",
      "Blocked",
      "{decisionMakerString} this {contentTypeText} goes against our {communityGuidelinesLink}. If you learn and follow our guidelines, you can prevent this group profile from being deleted.",
      ...
      "There's more to see from {username}",
      ...
      "People can scan this QR code with their smartphone's camera to see this story.",
      ...
      "We removed this {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. Even if the author post didn't mean to offend, our guidelines encourage people to express themselves in a way that's respectful to everyone.",
      "Continue on the Instagram app",
      "Close",
      ...
      "We use the same Community Guidelines around the world, and for everyone on Instagram.",
      "1m",
      "Firefox",
      "No",
      ...
      "th",
      "Cancel",
      "{decisionMakerString} this {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because violence can make some people feel unsafe on Instagram.",
      "Save",
      ...
      "Set Up Manually",
      "Comment icon",
      "To help keep our community authentic, we're showing information about accounts that reach a lot of people or advertise on Instagram.",
      "Add Photos",
      "News emails",
      "Former usernames",
      "Remove Account?",
      ...
      "Completing your profile helps people discover and learn about your business.",
      "You can block them anytime from their profile.",
      "You can choose to stop selling products that are shared with you at any time, or turn your shop visibility off in the shop management menu.",
      ...
      "Suggested Profiles",
      "Expired on {date}.",
      "You already spent {daily_quota} on Instagram today. You can come back tomorrow.",
      "trademark",
      "Public Business Information",
      ...
      "Chevron icon",
      "Shield icon on Accounts Center Interstitial",
      ...
      "Allow Sharing",
      "Save Draft",
      "The signature did not match, please try again.",
      "OK",
      "Tap to tag people",
      "Missed video call",
      ...
      "{decisionMakerString} this {contentTypeText} goes against our {communityGuidelinesLink}. Following our guidelines is the only way to prevent this group profile from being deleted, including the posts and members.",
      ...
      "OK",
      "Read the {full_terms} and {privacy_policy}",
      ...
      "ID Photo",
      "{likes} like",
      "Users icon on Accounts Center Interstitial",
      ...
      "Account Information",
      "{decisionMakerString} your {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. Our guidelines are based on our global community, and some audiences may be sensitive to different things.",
      ...
      "We removed this {contentTypeText} because it goes against our {brandedContentPoliciesLink}. Certain goods, services, or brands cannot be promoted with branded content, including tobacco products, weapons, ammunition or explosives. In addition, some categories, including social issues, elections, or politics, are only allowed in branded content posts if the paying partner has been authorized to run related ads.",
      ...
      "Log In:",
      "Comments",
      "We removed this {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. We have these guidelines because violence can make some people feel unsafe on Instagram.",
      "Are You a Creator?",
      ...
      "People will be able to call or text you at this number. Standard messaging rates apply.",
      "Settings icon",
      "Creator accounts are best for public figures, content producers, artists and influencers. You can switch back to a business account anytime.",
      ...
      "NetzDG/UrhDaG/Ranking of Content",
      "Please attach a photo of your ID",
      "Your photo lets your friends know it's you.",
      "Switch to {username}?",
      "Remove Authentication App?",
      "Shield icon on Facebook Pay learn more page",
      "User circle icon on Accounts Center Interstitial",
      "Shopping Icon",
      "Add file",
      "Instagram believes this publisher may be wholly or partially under the control of {country}.",
      "Create new post",
      ...
      "People can scan this QR code with their smartphone's camera to see this highlight.",
      ...
      "By {action text} you agree to our Terms and Policies. Currently, all fees are waived. {Learn more}",
      "Show posts",
      "You're all set!",
      "We've started creating a file of your information and will email a link to {email address} once it's ready. It may take up to 14 days to collect this information and send it to you.",
      "Get Reminder",
      "BY {user}",
      "Thanks For Letting Us Know",
      "All Suggestions",
      ...
      "{Bold text if your appeal for video is approved} the original video you shared won't share ad earnings with the copyright holder.",
      ...
      "Top posts",
      "Allow activity from {=application name} to stay connected to your account in Accounts Center.",
      "Allow Comments From",
      "Remove Account",
      "Close",
      ...
      "Continue connecting Instagram to {=application name}?",
      "Follow Back",
      "Add a profile photo so your friends know it's you.",
      "nd",
      "Gender",
      "Go live",
      "Edit Draft",
      "Allow accounts you follow and anyone you message to see when you were last active or are currently active on Instagram apps. When this is turned off, you won't be able to see the activity status of other accounts. {Learn more}",
      ...
      "report",
      "It's spam",
      "See more photos and videos from {username} and connect with them in new ways.",
      ...
      "Something else",
      "Inbox",
      "Use Instagram on a mobile device",
      "{days}d",
      ...
      "Only {account owner username} can see all followers.",
      "Contact Info",
      "Get Instagram Lite",
      "Ads Preferences",
      ...
      "No",
      "OK",
      "Videos must be 3 seconds or more",
      ...
      "Contact Content Owner",
      "Remove",
      "To download your video, view this in your archive on the Instagram app.",
      "Other",
      ...
      "Discover People",
      "Remove",
      "Use the Instagram app for this feature",
      "You have restricted {username}",
      "Log In With Google",
      "Delete Comment",
      ...
      "Phone Number",
      "More",
      "Discover more from {username} only on the app",
      ...
      "Phone Number",
      "Message {actionType} {prepositionType} {violationText}",
      "API Terms of Use",
      "LIVE FUNDRAISER",
      ...
      "Due to the high number of requests we’re receiving, it may take more than 48 hours to collect and send this email to you. Remember to check your spam inbox if you don’t see it.",
      "Ask Parent/Guardian",
      "Watch again on Instagram",
      "What this can mean legally in France",
      ...
      "Suggested for You",
      "Unfollow",
      "To block, you'll need to remove supervision first.",
      "Details of Appeal",
      ...
      "{decisionMakerString} your {contentTypeText} goes against our {communityGuidelinesLink} on {violationText}. Even if you didn't mean to offend, our guidelines encourage people to express themselves in a way that's respectful to everyone.",
      "This message puts people at risk",
      ...
      "Add Extra Security to Your Account",
      "We removed this {contentTypeText} because it goes against our {communityGuidelinesLink} on {violationText}. Following our guidelines is the only way to prevent this group profile from being deleted, including the posts and members.",
      "All videos are reviewed according to our {monetization policy link}.",
      ...
      "Preparing Draft",
      "Forgot PIN?",
      "Direct messaging - 1 new notification link",
      ...
      "You can allow the use of all cookies, just essential cookies or you can choose more options below. We’ll remember your cookie choices and apply them anywhere you’re logged into Instagram or Facebook, and where you use your accounts to log into other Facebook Products. You can review or change your choices at any time in your cookie settings.",
      "Learn More",
      "pm",
      "Enter Code",
      "Settings",
      ...
      "Create New Account",
      "Contact information",
      "You've already reviewed our updated Privacy Policy and agreed to our new Terms.",
      "Get a new code",
      "Image is blurred to protect you from unwanted content.",
      "Review changes to our Terms and Privacy Policy.",
      "Cookies",
      "QR Code",
      ...
      "Search",
      "Keep Account",
      "This is because some previous posts made to your account or group profile didn't follow our {Community Guidelines}. If a post to your account or group profile goes against our guidelines again, your account or group profile may be disabled, and the associated posts, archive, messages and followers will be permanently removed.",
